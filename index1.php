...
<body>
	...
	<table class="table" id="popularMoviesTable">
	 	...
	 	<tbody id="popularMovies">
	 		<tr>
	 			<td><a href="MoviePage/index.php" id="example" class="btn btn-success" rel="popover" data-content='By James Cameron' data-original-title="Avatar(2009)"><img src="Homepage/img/sample1.jpg" alt="" class="img-responsive"><span class="movieTitleInList">Avatar</span></td>
